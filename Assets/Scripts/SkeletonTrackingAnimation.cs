...
public class SkeletonTrackingAnimation : MonoBehaviour
{
    ...
    {
        m_hierarchyList.Add(new TransformWrapper(Omek.JointID.hips,  false));
        m_hierarchyList.Add(new TransformWrapper(Omek.JointID.waist,  false));
        ...
        m_hierarchyList.Add(new TransformWrapper(Omek.JointID.leftHip,  false));
        m_hierarchyList.Add(new TransformWrapper(Omek.JointID.rightHip,  false));
        m_hierarchyList.Add(new TransformWrapper(Omek.JointID.leftKnee,  false));
        m_hierarchyList.Add(new TransformWrapper(Omek.JointID.rightKnee,  false));

        m_hierarchyList.Add(new TransformWrapper(Omek.JointID.leftFoot,  false));
        m_hierarchyList.Add(new TransformWrapper(Omek.JointID.rightFoot,  false));
                
        m_hierarchyList.Add(new TransformWrapper(Omek.JointID.neck,   false));
        m_hierarchyList.Add(new TransformWrapper(Omek.JointID.head,  false));
